...
RSpec.describe "Tasks", type: :system do
  describe 'Fonction d\'enregistrement' do
    context 'Lors de l\'enregistrement d\'une tâche' do
      it 'La tâche enregistrée s\'affiche' do
        @task=FactoryBot.create(:task, title: 'Enquête concurrentielle', content: 'Enquêter sur les services d\'autres entreprises.')
        visit tasks_path
  ...
  describe 'Fonction d\'affichage de liste' do
    ...
    let!(:task1) { FactoryBot.create(:task, title: 'first_task_title') }
